...
/**
 * PaymentDirectResponseOrderStatusCardAuthInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentDirectResponseOrderStatusCardAuthInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'paymentDirectResponse_orderStatus_cardAuthInfo';
    ...
    */
    ...
    public function setPan($pan)
    {
        ...
        if ((mb_strlen($pan) > 20)) {
            throw new \InvalidArgumentException('invalid length for $pan when calling PaymentDirectResponseOrderStatusCardAuthInfo., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($pan) < 1)) {
            throw new \InvalidArgumentException('invalid length for $pan when calling PaymentDirectResponseOrderStatusCardAuthInfo., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9*]+$/", ObjectSerializer::toString($pan)))) {
            throw new \InvalidArgumentException("invalid value for \$pan when calling PaymentDirectResponseOrderStatusCardAuthInfo., must conform to the pattern /^[0-9*]+$/.");
        }
    ...
    public function setExpiration($expiration)
    {
        ...
        if ((mb_strlen($expiration) > 8)) {
            throw new \InvalidArgumentException('invalid length for $expiration when calling PaymentDirectResponseOrderStatusCardAuthInfo., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($expiration) < 1)) {
            throw new \InvalidArgumentException('invalid length for $expiration when calling PaymentDirectResponseOrderStatusCardAuthInfo., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d+$/", ObjectSerializer::toString($expiration)))) {
            throw new \InvalidArgumentException("invalid value for \$expiration when calling PaymentDirectResponseOrderStatusCardAuthInfo., must conform to the pattern /^\\d+$/.");
        }
    ...
    public function setCardHolderName($card_holder_name)
    {
        ...
        if ((mb_strlen($card_holder_name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $card_holder_name when calling PaymentDirectResponseOrderStatusCardAuthInfo., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($card_holder_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $card_holder_name when calling PaymentDirectResponseOrderStatusCardAuthInfo., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]+$/", ObjectSerializer::toString($card_holder_name)))) {
            throw new \InvalidArgumentException("invalid value for \$card_holder_name when calling PaymentDirectResponseOrderStatusCardAuthInfo., must conform to the pattern /^[ -~]+$/.");
        }
    ...
    public function setPaymentSystem($payment_system)
    {
        ...
        if ((mb_strlen($payment_system) > 10)) {
            throw new \InvalidArgumentException('invalid length for $payment_system when calling PaymentDirectResponseOrderStatusCardAuthInfo., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($payment_system) < 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_system when calling PaymentDirectResponseOrderStatusCardAuthInfo., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\w+$/", ObjectSerializer::toString($payment_system)))) {
            throw new \InvalidArgumentException("invalid value for \$payment_system when calling PaymentDirectResponseOrderStatusCardAuthInfo., must conform to the pattern /^\\w+$/.");
        }
