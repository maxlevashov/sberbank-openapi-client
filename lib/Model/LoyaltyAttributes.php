...
/**
 * LoyaltyAttributes Class Doc Comment
 *
 * @category Class
 ...
 */
class LoyaltyAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'loyaltyAttributes';
    ...
    */
    ...
    public function setSbrfSpasiboamountBonus($sbrf_spasiboamount_bonus)
    {
        ...
        if (($sbrf_spasiboamount_bonus > 4294967200)) {
            throw new \InvalidArgumentException('invalid value for $sbrf_spasiboamount_bonus when calling LoyaltyAttributes., must be smaller than or equal to 4294967200.');
        }
        if (($sbrf_spasiboamount_bonus < 0)) {
            throw new \InvalidArgumentException('invalid value for $sbrf_spasiboamount_bonus when calling LoyaltyAttributes., must be bigger than or equal to 0.');
        }
