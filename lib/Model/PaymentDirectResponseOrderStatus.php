...
/**
 * PaymentDirectResponseOrderStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentDirectResponseOrderStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'paymentDirectResponse_orderStatus';
    ...
    protected static $openAPITypes = [
        ...
        'card_auth_info' => '\Sberbank\Model\PaymentDirectResponseOrderStatusCardAuthInfo',
    ...
    */
    ...
    public function setOrderStatus($order_status)
    {
        ...
        if (($order_status > 9)) {
            throw new \InvalidArgumentException('invalid value for $order_status when calling PaymentDirectResponseOrderStatus., must be smaller than or equal to 9.');
        }
        if (($order_status < 0)) {
            throw new \InvalidArgumentException('invalid value for $order_status when calling PaymentDirectResponseOrderStatus., must be bigger than or equal to 0.');
        }
    ...
    public function setActionCode($action_code)
    {
        ...
        if (($action_code > 9999999)) {
            throw new \InvalidArgumentException('invalid value for $action_code when calling PaymentDirectResponseOrderStatus., must be smaller than or equal to 9999999.');
        }
        if (($action_code < -9999999)) {
            throw new \InvalidArgumentException('invalid value for $action_code when calling PaymentDirectResponseOrderStatus., must be bigger than or equal to -9999999.');
        }
    ...
    public function setActionCodeDescription($action_code_description)
    {
        ...
        if ((mb_strlen($action_code_description) > 512)) {
            throw new \InvalidArgumentException('invalid length for $action_code_description when calling PaymentDirectResponseOrderStatus., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($action_code_description) < 0)) {
            throw new \InvalidArgumentException('invalid length for $action_code_description when calling PaymentDirectResponseOrderStatus., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/^[ -~А-Яа-яЁё№]*$/", ObjectSerializer::toString($action_code_description)))) {
            throw new \InvalidArgumentException("invalid value for \$action_code_description when calling PaymentDirectResponseOrderStatus., must conform to the pattern /^[ -~А-Яа-яЁё№]*$/.");
        }
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling PaymentDirectResponseOrderStatus., must be smaller than or equal to 999999999999.');
        }
        if (($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling PaymentDirectResponseOrderStatus., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling PaymentDirectResponseOrderStatus., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling PaymentDirectResponseOrderStatus., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^\\d{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling PaymentDirectResponseOrderStatus., must conform to the pattern /^\\d{3}$/.");
        }
    ...
    public function setDate($date)
    {
        ...
        if (($date > 999999999999999)) {
            throw new \InvalidArgumentException('invalid value for $date when calling PaymentDirectResponseOrderStatus., must be smaller than or equal to 999999999999999.');
        }
        if (($date < 0)) {
            throw new \InvalidArgumentException('invalid value for $date when calling PaymentDirectResponseOrderStatus., must be bigger than or equal to 0.');
        }
     ...
     * Gets card_auth_info
     *
     * @return \Sberbank\Model\PaymentDirectResponseOrderStatusCardAuthInfo|null
     */
     ...
     * Sets card_auth_info
     *
     * @param \Sberbank\Model\PaymentDirectResponseOrderStatusCardAuthInfo|null $card_auth_info card_auth_info
     *
     * @return self
     */
    ...
    public function setApprovalCode($approval_code)
    {
        ...
        if ((mb_strlen($approval_code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $approval_code when calling PaymentDirectResponseOrderStatus., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($approval_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $approval_code when calling PaymentDirectResponseOrderStatus., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\w+$/", ObjectSerializer::toString($approval_code)))) {
            throw new \InvalidArgumentException("invalid value for \$approval_code when calling PaymentDirectResponseOrderStatus., must conform to the pattern /^\\w+$/.");
        }
    ...
    public function setAuthDateTime($auth_date_time)
    {
        ...
        if (($auth_date_time > 999999999999999)) {
            throw new \InvalidArgumentException('invalid value for $auth_date_time when calling PaymentDirectResponseOrderStatus., must be smaller than or equal to 999999999999999.');
        }
        if (($auth_date_time < 0)) {
            throw new \InvalidArgumentException('invalid value for $auth_date_time when calling PaymentDirectResponseOrderStatus., must be bigger than or equal to 0.');
        }
    ...
    public function setTerminalId($terminal_id)
    {
        ...
        if ((mb_strlen($terminal_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $terminal_id when calling PaymentDirectResponseOrderStatus., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($terminal_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $terminal_id when calling PaymentDirectResponseOrderStatus., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\w+$/", ObjectSerializer::toString($terminal_id)))) {
            throw new \InvalidArgumentException("invalid value for \$terminal_id when calling PaymentDirectResponseOrderStatus., must conform to the pattern /^\\w+$/.");
        }
    ...
    public function setAuthRefNum($auth_ref_num)
    {
        ...
        if ((mb_strlen($auth_ref_num) > 24)) {
            throw new \InvalidArgumentException('invalid length for $auth_ref_num when calling PaymentDirectResponseOrderStatus., must be smaller than or equal to 24.');
        }
        if ((mb_strlen($auth_ref_num) < 0)) {
            throw new \InvalidArgumentException('invalid length for $auth_ref_num when calling PaymentDirectResponseOrderStatus., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/^[A-Za-z0-9]+$/", ObjectSerializer::toString($auth_ref_num)))) {
            throw new \InvalidArgumentException("invalid value for \$auth_ref_num when calling PaymentDirectResponseOrderStatus., must conform to the pattern /^[A-Za-z0-9]+$/.");
        }
