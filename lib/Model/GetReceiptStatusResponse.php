...
class GetReceiptStatusResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getReceiptStatusResponse';
    ...
    protected static $openAPITypes = [
        ...
        'order_id' => 'string',
        'order_number' => 'string',
        'receipts' => '\Sberbank\Model\ReceiptsInner[]'
    ];
    ...
    */
     ...
     * Gets receipts
     *
     * @return \Sberbank\Model\ReceiptsInner[]|null
     */
     ...
     * Sets receipts
     *
     * @param \Sberbank\Model\ReceiptsInner[]|null $receipts Массив объектов, содержащий информацию по чекам в рамках заказа.
     *
     * @return self
     */
