...
/**
 * AutoRefundRequest Class Doc Comment
 *
 * @category Class
 * @package  Sberbank
 * @author   OpenAPI Generator team
 ...
 */
class AutoRefundRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'autoRefundRequest';
    ...
    */
    ...
    public function setUserName($user_name)
    {
        ...
        if ((mb_strlen($user_name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $user_name when calling AutoRefundRequest., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($user_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $user_name when calling AutoRefundRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[A-Za-z0-9-_ ]+$/", ObjectSerializer::toString($user_name)))) {
            throw new \InvalidArgumentException("invalid value for \$user_name when calling AutoRefundRequest., must conform to the pattern /^[A-Za-z0-9-_ ]+$/.");
        }
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) > 30)) {
            throw new \InvalidArgumentException('invalid length for $password when calling AutoRefundRequest., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $password when calling AutoRefundRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[ -~]+$/", ObjectSerializer::toString($password)))) {
            throw new \InvalidArgumentException("invalid value for \$password when calling AutoRefundRequest., must conform to the pattern /^[ -~]+$/.");
        }
    ...
    public function setOrderId($order_id)
    {
        ...
        if ((mb_strlen($order_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling AutoRefundRequest., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($order_id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling AutoRefundRequest., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/^[a-f0-9\\-]+$/", ObjectSerializer::toString($order_id)))) {
            throw new \InvalidArgumentException("invalid value for \$order_id when calling AutoRefundRequest., must conform to the pattern /^[a-f0-9\\-]+$/.");
        }
    ...
    public function setCompositeAmount($composite_amount)
    {
        ...
        if (($composite_amount > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $composite_amount when calling AutoRefundRequest., must be smaller than or equal to 999999999999.');
        }
        if (($composite_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $composite_amount when calling AutoRefundRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setLanguage($language)
    {
        ...
        if ((mb_strlen($language) > 2)) {
            throw new \InvalidArgumentException('invalid length for $language when calling AutoRefundRequest., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($language) < 2)) {
            throw new \InvalidArgumentException('invalid length for $language when calling AutoRefundRequest., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[a-z]+$/", ObjectSerializer::toString($language)))) {
            throw new \InvalidArgumentException("invalid value for \$language when calling AutoRefundRequest., must conform to the pattern /^[a-z]+$/.");
        }
