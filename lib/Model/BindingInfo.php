...
class BindingInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'bindingInfo';
    ...
    protected static $attributeMap = [
        ...
        'spasibo_allowed' => 'spasiboAllowed'
    ];
    ...
    protected static $setters = [
        ...
        'spasibo_allowed' => 'setSpasiboAllowed'
    ];
    ...
    protected static $getters = [
        ...
        'spasibo_allowed' => 'getSpasiboAllowed'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('spasibo_allowed', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets spasibo_allowed
     *
     * @return bool|null
     */
    public function getSpasiboAllowed()
    {
        return $this->container['spasibo_allowed'];
    }

    /**
     * Sets spasibo_allowed
     *
     * @param bool|null $spasibo_allowed Признак наличия Спасибо на связке. Возвращается при создании связки SberPay, при условии подтверждения списание боунсов Спасибо Плательщиком
     *
     * @return self
     */
    public function setSpasiboAllowed($spasibo_allowed)
    {
        if (is_null($spasibo_allowed)) {
            throw new \InvalidArgumentException('non-nullable spasibo_allowed cannot be null');
        }
        $this->container['spasibo_allowed'] = $spasibo_allowed;
